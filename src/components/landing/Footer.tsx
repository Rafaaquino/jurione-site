        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3 text-sm">
              <a href="mailto:contato@jurione.com.br" className="flex items-center gap-3 text-background/60 hover:text-background transition-colors">
                <Mail className="w-4 h-4" />
                contato@jurione.com.br
              </a>
              <a href="tel:+5511999999999" className="flex items-center gap-3 text-background/60 hover:text-background transition-colors">
